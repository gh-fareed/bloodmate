            ...
            <tr class="card mb-1" style="background-color: #fee6e4;border-radius: 5px">
                    ...
                    <td class="d-flex">
                        ...
                        <div class="col-10">
                            ...
                            Phone No: {{$d->phoneno}}
                            <br/>
                            Request Date: {{$d->reqdate}}
                            <br/>
                            Purpose: {{$d->purpose}}
                            <br/>
                            Request Status: {{$d->rstatus}}
                            <br>
                            <br/>
                            @if($d->rstatus=="Accepted" || $d->rstatus=="Denied" || $d->rstatus=="Deleted")

                            @else
                            <a href="/opprequest/{{$d->did}}" class="btn btn-danger">Accept</a>&nbsp;&nbsp;<a href="/opprequestd/{{$d->did}}" class="btn btn-danger">Deny</a>
