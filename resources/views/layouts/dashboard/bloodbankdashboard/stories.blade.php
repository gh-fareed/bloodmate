  ...
  <div class="wrapper ">
    ...
    <div class="container" style="margin-top: 120px; margin-bottom: 20px;padding: 10px; border: 1px solid lightgrey; border-radius: 5px;">
    	<div class="row">
          ...
          @endif
   <form action="/savedonorstory" method="post">
   	@csrf
   	
   	<div class="form-group">
   		<label> <strong>Title:</strong> </label>
   		<input type="text" name="storytitle" class="form-control form-control-lg">
   	</div>
   	<div class="form-group">
   		<label> <strong>Story:</strong> </label>
   		<textarea  name="storytext" rows="10" cols="55"></textarea>
   	</div>
   	<button class="btn btn-danger btn-lg" type="submit">Add Story</button>
   </form>
</div>
</div>
</div>
